...
then
    ...
    #chmod --reference="$KASMCERTSDIRECTORY/db_server.key" "$KASMCERTSDIRECTORY/kasm_nginx.key"
    #chmod --reference="$KASMCERTSDIRECTORY/db_server.key" "$KASMCERTSDIRECTORY/kasm_nginx.crt"
